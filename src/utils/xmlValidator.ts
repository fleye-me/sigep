export const xml2string: string = `
...
<xs:element name="ciencia_conteudo_proibido">
  <xs:simpleType>
    <xs:restriction base="xs:string">
...
<xs:element name="restricao_anac">
  <xs:simpleType>
    <xs:restriction base="xs:string">
      <xs:maxLength value="1"/>
    </xs:restriction>
...
<xs:element ref="ciencia_conteudo_proibido"/>
</xs:sequence>
</xs:complexType>
</xs:element>
<xs:element name="plp">
